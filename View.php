 ...
 *
 * @version 1.0
 * @package McGowan Corp. PHP Library
 */
namespace McGowanCorp
{
    ...
    class View
    {
         ...
         * toString
         *
         * Used to transform this view object instance as a string.
         *
         * @access public
         * @param void
         ...
         * __toString
         *
         * Allows for the use of this object as a string.
         *
         * @access public
         * @param void
         * @return string Returns the rendered view (calls View::toString).
         */
